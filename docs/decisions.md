...
- Date: 2026-02-22
- Status: accepted
- Decision: Replace manual latitude/longitude fields with explicit `Locate` flow (GPS + reverse place lookup / `No reception`) and use 3 camera-first photo slots with thumbnail preview/replace controls.
